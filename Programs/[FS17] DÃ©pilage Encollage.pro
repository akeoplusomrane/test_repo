{
  "Id": 0,
  "ReferenceName": "[FS17] Dépilage Encollage",
  "Main": {
    "$type": "AkeoCore.Programming.Structures.Macro, AkeoCore",
    "Order": 0,
    "Name": "[FS17] Dépilage Encollage",
    "IsAsync": false,
    "ComponentIDs": [],
    "ChildActions": [
      {
            ...
            "ChildActions": [
              {
                ...
                "ChildActions": [
                  ...
                  {
                    "$type": "AkeoRoboticist.Advanced.SendCustomCommand, AkeoRoboticist",
                    "Order": 1,
                    "Name": "/!\\ Trajectoire Encollage /!\\ ",
                    "IsAsync": false,
                    "ComponentIDs": [
                      2
                    ],
                    ...
                    "Ports": {
                      "Command": {
                        ...
                        "TypeName": "System.String, mscorlib",
                        "PortType": 2,
                        "CurrentValue": "<PCVision><Cmd><Code>15</Code><Arg1>0</Arg1><Arg2>0</Arg2></Cmd></PCVision>",
                        "Behavior": 0,
                        "ProducerIDs": []
                      },
                      "Wait Ack": {
                    ...
                    "ChildActions": [
                      {
                        "$type": "AkeoRoboticist.Motion.RobotTrajectory, AkeoRoboticist",
                        "Order": 0,
                        "Name": "[TRAJ] Doseuse -> Plateau BACK",
                        "IsAsync": false,
                        "ComponentIDs": [
                          2
                        ],
